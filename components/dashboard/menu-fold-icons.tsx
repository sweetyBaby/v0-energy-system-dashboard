...
// Shared by the dashboard sidebar's collapse toggle and TrendWorkspace's rail
// header so both use the same affordance.

export function MenuFoldIcon({ className }: { className?: string }) {
  return (
...
export function MenuUnfoldIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 1024 1024" fill="currentColor" className={className} aria-hidden="true">
